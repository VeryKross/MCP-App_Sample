...
public class FanTools
{
    ...
    public static string SearchMerchandise(
        [Description("Filter by team name (e.g. 'Apex Racing')")] string? team = null,
        [Description("Filter by category (e.g. 'Team Shirt', 'Hat', 'Accessory', 'Drinkware', 'Apparel', 'Equipment', 'Collectible')")] string? category = null,
    ...
    public static string CreatePromotion(
        ...
        [Description("Product category to apply promotion to (e.g. 'Team Shirt', 'Hat', or 'all')")] string productCategory,
