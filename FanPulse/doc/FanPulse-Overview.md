...
which races they've attended, what they've bought, and how engaged they are. No more digging
...
### 📊 Engagement Tracking
Every time a fan attends a race, opens the app, shares something on social media, or watches
content, Fan Pulse records it.This builds a rich history of how each fan interacts with
your organization over time.

**Example question you could ask:**
> "Log that fan-003 attended today's Pacific Drift Grand Prix."
...
**Example question you could ask:**
> "Show me all Apex Racing team shirts under $100."
...
**Example question you could ask:**
> "Create a 20% off team shirt promotion for fans who attend races but haven't bought anything."
...
**Example question you could ask:**
> "Show me fan segments for Apex Racing fans."
...
- **12 fans** across three teams (Apex Racing, Pacific Drift, Alpine Velocity)
- **44 engagement events** (race attendance, app usage, social shares, content views)
- **25 merchandise products** (team shirts, hats, accessories, drinkware, apparel, collectibles)
...
> These include Priya Sharma (Pacific Drift, 5 events), Aisha Hassan (Apex Racing, 5 events),
> and James O'Brien (Apex Racing, 3 events)."
>
> **You:** "What would you recommend for Priya?"
>
> **Assistant:** "Priya's favorite players are Carlos Vega and Mei Lin. I'd recommend the
> Carlos Vega #11 Team Shirt ($104.99) and the Mei Lin #5 Team Shirt ($104.99) as top picks, followed
> by the Pacific Drift Team Shirt ($84.99) and Pacific Drift Cap ($27.99) as complementary items."
>
> **You:** "Let's create a 15% off promotion on team shirts for that whole segment."
>
> **Assistant:** "Done! Created promotion 'Team Shirt Boost Q1' — 15% off all team shirts, targeting
