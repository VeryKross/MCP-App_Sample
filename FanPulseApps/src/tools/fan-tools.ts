...
const SearchMerchInput = z.object({
  team: z.string().optional().describe("Filter by team name (e.g. 'Apex Racing')"),
  category: z
    .string()
    .optional()
    .describe("Filter by category (e.g. 'Team Shirt', 'Hat', 'Accessory', 'Drinkware', 'Apparel', 'Equipment', 'Collectible')"),
...
const CreatePromoInput = z.object({
  ...
  productCategory: z.string().describe("Product category to apply promotion to (e.g. 'Team Shirt', 'Hat', or 'all')"),
