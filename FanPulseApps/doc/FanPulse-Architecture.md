...
graph TD
    subgraph "Same Question"
        Q["Show me fan segments<br/>for Apex Racing"]
    end
...
erDiagram
    ...
    Merchandise {
        ...
        text Name
        text Category "Team Shirt, Hat, Apparel, etc."
        text Team
        text Player
        real Price
        int InStock
...
and 8 purchase records across three fictional teams (Apex Racing, Pacific Drift, Alpine Velocity).
